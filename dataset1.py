...
class Datasets(Dataset):
    ...
    def __init__(self, path):
        ...
        self.name2 = os.listdir(os.path.join(path, "gt"))
    ...
    def __getitem__(self, index):
        ...
        # 图片和标签的路径
        img_path = [os.path.join(self.path, i) for i in ("images", "gt")]
        # 读取原始图片和标签，并转RGB
...
if __name__ == '__main__':
    i = 1
    dataset = Datasets(r"E:\python\shendu\second\yuyifenge\msrc2_seg")
    for a, b in dataset:
        print(i)
        # print(a.shape)
        # print(b.shape)
